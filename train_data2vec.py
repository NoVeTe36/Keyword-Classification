...
def main(args):
    ...
    # Override train_list_file if custom_pretrain_list is provided
    if args.custom_pretrain_list:
        config["train_list_file"] = args.custom_pretrain_list
        print(f"Using custom pretrain list: {args.custom_pretrain_list}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--custom_pretrain_list", type=str, required=False, 
                        help="Path to custom pretraining list file.", default=None)
